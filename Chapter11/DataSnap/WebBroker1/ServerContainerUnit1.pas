...
constructor TServerContainer3.Create(AOwner: TComponent);
begin
  inherited;
  FDSServer := DSServer1;
...
destructor TServerContainer3.Destroy;
begin
  inherited;
  FDSServer := nil;
...
procedure TServerContainer3.DSAuthenticationManager1UserAuthorize(
...
initialization
  FModule := TServerContainer3.Create(nil);
finalization
  FModule.Free;
end.

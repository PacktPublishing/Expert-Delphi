...
function TFormToDoS3.GetToDoData: IToDoData;
begin
...
procedure TFormToDoS3.actAddExecute(Sender: TObject);
begin
  FCurrentId := -1;
  edtTitle.Text := '';
  edtCategory.Text := '';
...
procedure TFormToDoS3.actDeleteExecute(Sender: TObject);
begin
...
procedure TFormToDoS3.actSaveExecute(Sender: TObject);
var todo: TToDo;
begin
...
procedure TFormToDoS3.FormCreate(Sender: TObject);
begin
...
procedure TFormToDoS3.FormDestroy(Sender: TObject);
begin
  FToDos.Free;
end;

procedure TFormToDoS3.lstvwToDosDeleteItem(Sender: TObject; AIndex: Integer);
begin
  FCurrentId := FToDos[AIndex].Id;
  actDelete.Execute;
end;

procedure TFormToDoS3.lstvwToDosItemClick(const Sender: TObject;
  const AItem: TListViewItem);
var todo: TToDo;
begin
...
procedure TFormToDoS3.RefreshList;
